            ...
            <View style={styles.content}>
              ...
              {creating ? (
                ...
                >
                  ...
                  {duplicateWarning ? <ThemedText type="small" themeColor="warning">{duplicateWarning}</ThemedText> : null}
                ...
                <>
                  ...
                  <ScrollView style={styles.list} contentContainerStyle={styles.listContent} keyboardShouldPersistTaps="handled">
                    {exercises.map((exercise) => (
                      ...
                      >
                        <View style={styles.exerciseText}>
                          ...
                          <ThemedText type="small" themeColor="textSecondary">{exercise.category}</ThemedText>
                    ...
                    {error ? <ThemedText type="small" themeColor="danger" style={{ textAlign: "center" }}>{error}</ThemedText> : null}
                    {exercises.length === 0 ? <ThemedText type="small" themeColor="textSecondary" style={{ textAlign: "center" }}>No matching exercises.</ThemedText> : null}
                  </ScrollView>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1 },
  modal: { alignItems: "center", flex: 1, padding: Spacing.three },
  content: { flex: 1, gap: Spacing.three, maxWidth: MaxContentWidth, minWidth: 0, width: "100%" },
  header: { alignItems: "center", flexDirection: "row", justifyContent: "space-between" },
  iconButton: { alignItems: "center", height: 44, justifyContent: "center", width: 44 },
  list: { flex: 1, minHeight: 0, width: "100%" },
  listContent: { gap: Spacing.two, paddingVertical: Spacing.two },
  exercise: { alignItems: "center", borderRadius: Radius.large, borderWidth: 1, flexDirection: "row", gap: Spacing.two, minHeight: 72, padding: Spacing.three },
